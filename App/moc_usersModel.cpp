...
#include "../../ChatClient/head/usersModel.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_usersModel_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_usersModel_t qt_meta_stringdata_usersModel = {
    {
QT_MOC_LITERAL(0, 0, 10) // "usersModel"
...
const QMetaObject usersModel::staticMetaObject = {
    { &QAbstractListModel::staticMetaObject, qt_meta_stringdata_usersModel.data,
      qt_meta_data_usersModel,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *usersModel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_usersModel.stringdata))
        return static_cast<void*>(const_cast< usersModel*>(this));
